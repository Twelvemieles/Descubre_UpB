...
/////// Diffuse:
                ...
                float node_7852 = saturate((_waters_var.r+_front_var.r));
                float3 diffuseColor = float3(node_7852,node_7852,node_7852);
                float3 diffuse = (directDiffuse + indirectDiffuse) * diffuseColor;
/// Final Color:
                float3 finalColor = diffuse;
                fixed4 finalRGBA = fixed4(finalColor,_front_var.r);
